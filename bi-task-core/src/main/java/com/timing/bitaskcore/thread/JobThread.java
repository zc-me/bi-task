...
public class JobThread extends Thread{
	...
	public void run() {
		...
		while(!toStop){
            ...
            try {
				...
				if (triggerParam!=null) {
					...
					// execute
					XxlJobHelper.log("<br>----------- bi-task job execute start -----------<br>----------- Param:" + xxlJobContext.getJobParam());
					...
					if (triggerParam.getExecutorTimeout() > 0) {
						...
						try {
							...
							XxlJobHelper.log("<br>----------- bi-task job execute timeout");
							XxlJobHelper.log(e);
					...
					XxlJobHelper.log("<br>----------- bi-task job execute end(finish) -----------<br>----------- Result: handleCode="
				...
				XxlJobHelper.log("<br>----------- JobThread Exception:" + errorMsg + "<br>----------- bi-task job execute end(error) -----------");
			} finally {
                if(triggerParam != null) {
		...
		logger.info(">>>>>>>>>>> bi-task JobThread stoped, hashCode:{}", Thread.currentThread());
	}
}
